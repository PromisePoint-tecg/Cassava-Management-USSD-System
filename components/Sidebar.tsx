  ...
  return (
    <>
      ...
      >
        ...
        {/* Logo Section */}
        <div className="h-20 flex items-center justify-left px-4 relative">
          <div className="relative group">
            ...
            <img 
              ...
              className={`relative transition-all duration-500 object-contain ${isCollapsed ? "h-9" : "h-20"}`}
            />
          </div>
        </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`
                  w-full group relative flex items-center rounded-xl py-2.5 transition-all duration-500 overflow-hidden
              ...
              >
                ...
                <Icon
                  className={`
                    ...
                    ${isCollapsed ? "w-[18px] h-[18px]" : "w-[18px] h-[18px] mr-3"}
                    ${isActive 
                      ? "text-[#066f48]" 
                ...
                {!isCollapsed && (
                  <span className={`text-[13px] font-medium tracking-tight relative z-10 transition-all duration-300 ${isActive ? "text-[#066f48]" : "text-slate-500 group-hover:text-slate-700"}`}>
                    {item.label}
                  </span>
                )}
              </button>
